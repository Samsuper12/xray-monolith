...
inline CEntityAlive const* CEnemyManager::selected() const
{
...
inline void CEnemyManager::set_enemy(CEntityAlive const* enemy)
{
...
inline void CEnemyManager::invalidate_enemy()
{
