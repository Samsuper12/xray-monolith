...
inline CSActionPlannerActionScript::CActionPlannerActionScript(const xr_vector<COperatorCondition>& conditions,
...
TEMPLATE_SPECIALIZATION
inline CSActionPlannerActionScript::CActionPlannerActionScript(_object_type* object, LPCSTR action_name) :
