...
inline CScriptWatchAction::CScriptWatchAction(SightManager::ESightType tWatchType, CScriptGameObject* tpObjectToWatch,
...
inline void CScriptWatchAction::SetWatchBone(LPCSTR bone_to_watch)
{
