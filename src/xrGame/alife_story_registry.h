...
public:
	...
	inline void remove(ALife::_STORY_ID id, bool no_assert = false);
	inline const STORY_REGISTRY& objects() const;
	inline CSE_ALifeDynamicObject* object(ALife::_STORY_ID id, bool no_assert = false) const;
};
