...
public:
	...
	inline void add_edge(const _vertex_id_type& vertex_id0, const _vertex_id_type& vertex_id1,
	...
	inline const _edge_weight_type get_edge_weight(const _vertex_id_type vertex_index0, const _vertex_id_type vertex_index1,
	                                           const_iterator i) const;
	inline bool is_accessible(const _vertex_id_type vertex_index) const;
	inline _vertex_id_type const& value(_vertex_id_type const& vertex_index, const_iterator i) const;
	inline void begin(const CVertex* vertex, const_iterator& b, const_iterator& e) const;
	inline void begin(_vertex_id_type const& vertex_index, const_iterator& b, const_iterator& e) const;
};
