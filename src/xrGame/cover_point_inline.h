...
inline CCoverPoint::CCoverPoint(Fvector const& point, u32 const& level_vertex_id) :
	m_position(point),
...
inline Fvector const& CCoverPoint::position() const
{
	return (m_position);
}
...
inline bool CCoverPoint::operator==(CCoverPoint const& point) const
{
