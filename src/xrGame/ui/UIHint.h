...
public:
	...
	inline void set_visible(bool status = true) { m_visible = status; }
	inline bool is_visible() const { return m_visible; }

	inline void set_rect(Frect const& rect) { m_rect.set(rect); }
	inline Frect const& get_rect() const { return m_rect; }
...
public:
	...
	inline void set_hint_wnd(UIHint* hint_wnd) { m_hint_wnd = hint_wnd; }
	inline UIHint* get_hint_wnd() const { return m_hint_wnd; }

	inline void set_hint_delay(u32 delay) { m_hint_delay = delay; }
	inline u32 get_hint_delay() const { return m_hint_delay; }
