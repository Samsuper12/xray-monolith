...
public:
	...
	inline const Ivector2& GetGridSize() { return m_grid_size; }; //size in grid
	inline void SetAccelerator(int dik) { m_accelerator = dik; };
	inline int GetAccelerator() const { return m_accelerator; };
