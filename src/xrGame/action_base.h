...
#endif
	inline CActionBase(const xr_vector<COperatorCondition>& conditions, const xr_vector<COperatorCondition>& effects,
	               _object_type* object = 0, LPCSTR action_name = "");
	inline CActionBase(_object_type* object, LPCSTR action_name = "");
	virtual ~CActionBase();
