...
inline CTradeFactors::CTradeFactors(const float& friend_factor, const float& enemy_factor)
{
...
inline const float& CTradeFactors::friend_factor() const
{
	VERIFY(_valid(m_friend_factor));
	return (m_friend_factor);
}

inline const float& CTradeFactors::enemy_factor() const
{
