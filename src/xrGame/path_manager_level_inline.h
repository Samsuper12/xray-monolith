...
TEMPLATE_SPECIALIZATION
inline _dist_type CLevelPathManager::evaluate(const _index_type& node_index1, const _index_type& node_index2,
...
TEMPLATE_SPECIALIZATION
inline void CLevelPathManager::begin(const _index_type& vertex_id, _Graph::const_iterator& begin, _Graph::const_iterator& end)
{
	this->graph->begin(best_node, begin, end);
}

TEMPLATE_SPECIALIZATION
inline const _index_type CLevelPathManager::get_value(_Graph::const_iterator& i) const
{
