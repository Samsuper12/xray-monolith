...
inline void CCustomMonster::vfNormalizeSafe(Fvector& Vector)
{
...
inline bool left_angle(float y1, float y2)
{
...
inline moving_object* CCustomMonster::get_moving_object() const
{
