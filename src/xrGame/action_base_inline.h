...
inline CBaseAction::CActionBase(const xr_vector<COperatorCondition>& conditions,
...
TEMPLATE_SPECIALIZATION
inline CBaseAction::CActionBase(_object_type* object, LPCSTR action_name)
{
	init(object, action_name);
}
...
#ifdef LOG_ACTION
TEMPLATE_SPECIALIZATION
inline	void CBaseAction::show			(LPCSTR offset)
{
}
#endif
