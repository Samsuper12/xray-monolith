...
bool actor::update_doors(doors_type const& detected_doors, float const average_speed)
{
	...
	temp_doors_type new_doors_to_open(alloca(detected_doors_count * sizeof(doors_type::value_type)),
	                                  detected_doors_count);
	temp_doors_type new_doors_to_close(alloca(detected_doors_count * sizeof(doors_type::value_type)),
	                                   detected_doors_count);
