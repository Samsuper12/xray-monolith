...
public:
	...
	inline void set_destroy_time(u32 delta_destroy_time) { m_dwDestroyTime = delta_destroy_time + Device.dwTimeGlobal; }
...
public:
	...
	inline u32 destroy_time() const { return m_dwDestroyTime; }
	inline int time_from_begin_throw() const { return (Device.dwTimeGlobal + m_dwDestroyTimeMax - m_dwDestroyTime); }
