...
void show_animations		()
{
	...
	const ANIMATION_STATS_PAIR		**const animations = (ANIMATION_STATS_PAIR const **)alloca(animation_count*sizeof(ANIMATION_STATS_PAIR*));
...
void show_blends			()
{
	...
	const BLEND_STATS_PAIR			**const blends = (BLEND_STATS_PAIR const **)alloca(blend_count*sizeof(BLEND_STATS_PAIR*));
