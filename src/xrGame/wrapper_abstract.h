...
public:
	inline CWrapperAbstract();
	template <typename T1>
	inline CWrapperAbstract(T1 t1);
	template <typename T1, typename T2, typename T3>
	inline CWrapperAbstract(T1 t1, T2 t2, T3 t3);
...
public:
	inline CWrapperAbstract2();
	template <typename T1>
	inline CWrapperAbstract2(T1 t1);
	template <typename T1, typename T2>
	inline CWrapperAbstract2(T1 t1, T2 t2);
	template <typename T1, typename T2, typename T3>
	inline CWrapperAbstract2(T1 t1, T2 t2, T3 t3);
	template <typename T1, typename T2, typename T3, typename T4>
	inline CWrapperAbstract2(T1 t1, T2 t2, T3 t3, T4 t4);
	template <typename T1, typename T2, typename T3, typename T4, typename T5>
	inline CWrapperAbstract2(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5);
