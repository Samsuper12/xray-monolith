...
public:
	inline CActionScriptBase(const xr_vector<COperatorCondition>& conditions, const xr_vector<COperatorCondition>& effects,
	                     _object_type* object = 0, LPCSTR action_name = "");
	inline CActionScriptBase(_object_type* object = 0, LPCSTR action_name = "");
