...
inline float const& smart_cover::object::enter_min_enemy_distance() const
{
	return (m_enter_min_enemy_distance);
}

inline float const& smart_cover::object::exit_min_enemy_distance() const
{
	return (m_exit_min_enemy_distance);
}

inline smart_cover::cover const& smart_cover::object::cover() const
{
	VERIFY(m_cover);
	return (*m_cover);
}
