...
public:
	...
	virtual bool is_sun_static() override { return o.sunstatic; }
	virtual DWORD get_dx_level() override { return /*HW.pDevice1?0x000A0001:*/0x000A0000; }
	...
	virtual LPCSTR getShaderPath() override { return "r3\\"; }
	...
	virtual u32 active_phase() override { return phase; }; //Swatz: actor shadow
