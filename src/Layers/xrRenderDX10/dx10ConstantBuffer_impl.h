...
inline Fvector4* dx10ConstantBuffer::Access(u16 offset)
{
...
inline void dx10ConstantBuffer::set(R_constant* C, R_constant_load& L, const Fmatrix& A)
{
...
inline void dx10ConstantBuffer::set(R_constant* C, R_constant_load& L, const Fvector4& A)
{
	VERIFY(RC_float == C->type);
...
inline void dx10ConstantBuffer::set(R_constant* C, R_constant_load& L, float A)
{
	VERIFY(RC_float == C->type);
	VERIFY(RC_1x1 == L.cls);
	float* it = (float*)Access(L.index);
...
inline void dx10ConstantBuffer::set(R_constant* C, R_constant_load& L, int A)
{
...
inline void dx10ConstantBuffer::seta(R_constant* C, R_constant_load& L, u32 e, const Fmatrix& A)
{
	//	TEST
	//return;
	VERIFY(RC_float == C->type);
...
inline void dx10ConstantBuffer::seta(R_constant* C, R_constant_load& L, u32 e, const Fvector4& A)
{
	//	TEST
	//return;
	VERIFY(RC_float == C->type);
...
inline void* dx10ConstantBuffer::AccessDirect(R_constant_load& L, u32 DataSize)
{
	//	Check buffer size in client code: don't know if actual data will cross
	//	buffer boundaries.
