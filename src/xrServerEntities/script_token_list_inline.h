...
inline void CScriptTokenList::add(LPCSTR name, int id)
{
...
inline void CScriptTokenList::remove(LPCSTR name)
{
...
inline int CScriptTokenList::id(LPCSTR name)
{
	iterator I = token(name);
	VERIFY(I != m_token_list.end());
	return ((*I).id);
...
inline LPCSTR CScriptTokenList::name(int id)
{
	iterator I = token(id);
	VERIFY(I != m_token_list.end());
	return ((*I).name);
...
inline CScriptTokenList::iterator CScriptTokenList::token(LPCSTR name)
{
