...
#undef ROT
	...
	IC SelfRef MxMpV(SelfCRef M1, SelfCRef M2, const Tvector& vec)
	{
		m[0][0] = (M1.m[0][0] * M2.m[0][0] +
			M1.m[0][1] * M2.m[1][0] +
			M1.m[0][2] * M2.m[2][0] + vec.x);
		m[1][0] = (M1.m[1][0] * M2.m[0][0] +
			M1.m[1][1] * M2.m[1][0] +
			M1.m[1][2] * M2.m[2][0] + vec.y);
		m[2][0] = (M1.m[2][0] * M2.m[0][0] +
			M1.m[2][1] * M2.m[1][0] +
			M1.m[2][2] * M2.m[2][0] + vec.z);
		m[0][1] = (M1.m[0][0] * M2.m[0][1] +
			M1.m[0][1] * M2.m[1][1] +
			M1.m[0][2] * M2.m[2][1] + vec.x);
		m[1][1] = (M1.m[1][0] * M2.m[0][1] +
			M1.m[1][1] * M2.m[1][1] +
			M1.m[1][2] * M2.m[2][1] + vec.y);
		m[2][1] = (M1.m[2][0] * M2.m[0][1] +
			M1.m[2][1] * M2.m[1][1] +
			M1.m[2][2] * M2.m[2][1] + vec.z);
		m[0][2] = (M1.m[0][0] * M2.m[0][2] +
			M1.m[0][1] * M2.m[1][2] +
			M1.m[0][2] * M2.m[2][2] + vec.x);
		m[1][2] = (M1.m[1][0] * M2.m[0][2] +
			M1.m[1][1] * M2.m[1][2] +
			M1.m[1][2] * M2.m[2][2] + vec.y);
		m[2][2] = (M1.m[2][0] * M2.m[0][2] +
			M1.m[2][1] * M2.m[1][2] +
			M1.m[2][2] * M2.m[2][2] + vec.z);
		return *this;
	}
