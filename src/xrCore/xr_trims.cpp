...
LPCSTR _CopyVal(LPCSTR src, char * dst, u32 const dst_size, char separator)
{
	LPCSTR p;
	size_t n;
...
char * _GetItem(LPCSTR src, int index, char * dst, u32 const dst_size, char separator, LPCSTR def, bool trim)
{
	LPCSTR ptr;
