...
namespace text_editor
{
	...
	void line_edit_control::update_key_states()
	{
		...
		set_key_state(ks_LShift, !!pSDL3Input->iGetAsyncKeyState(SDL_SCANCODE_LSHIFT));
		set_key_state(ks_RShift, !!pSDL3Input->iGetAsyncKeyState(SDL_SCANCODE_RSHIFT));
		set_key_state(ks_LCtrl, !!pSDL3Input->iGetAsyncKeyState(SDL_SCANCODE_LCTRL));
		set_key_state(ks_RCtrl, !!pSDL3Input->iGetAsyncKeyState(SDL_SCANCODE_RCTRL));
		set_key_state(ks_LAlt, !!pSDL3Input->iGetAsyncKeyState(SDL_SCANCODE_LALT));
		set_key_state(ks_RAlt, !!pSDL3Input->iGetAsyncKeyState(SDL_SCANCODE_RALT));
