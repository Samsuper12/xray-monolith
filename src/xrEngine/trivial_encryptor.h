...
#ifdef TRIVIAL_ENCRYPTOR_ENCODER
public:
    inline static void encode(pcvoid source, const u32& source_size, pvoid destination)
    {
...
#ifdef TRIVIAL_ENCRYPTOR_DECODER
public:
    inline static void decode(pcvoid source, const u32& source_size, pvoid destination)
    {
# ifndef TRIVIAL_ENCRYPTOR_ENCODER
        static bool m_initialized = false;
# endif // TRIVIAL_ENCRYPTOR_ENCODER
