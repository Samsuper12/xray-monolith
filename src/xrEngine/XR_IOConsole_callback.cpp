...
void CConsole::Register_callbacks()
{
	...
	ec().assign_callback(SDL_SCANCODE_MEDIA_NEXT_TRACK, text_editor::ks_free, Callback(this, &CConsole::Next_log));
	ec().assign_callback(SDL_SCANCODE_PRIOR, text_editor::ks_Ctrl, Callback(this, &CConsole::Begin_log));
	ec().assign_callback(SDL_SCANCODE_MEDIA_NEXT_TRACK, text_editor::ks_Ctrl, Callback(this, &CConsole::End_log));
	...
	ec().assign_callback(SDL_SCANCODE_MEDIA_NEXT_TRACK, text_editor::ks_Alt, Callback(this, &CConsole::PageDown_tips));
	...
	//Screenshot
	ec().assign_callback(SDL_SCANCODE_F12, text_editor::ks_free, Callback(this, &CConsole::Screenshot));
}
